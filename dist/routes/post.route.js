...
import { createPost, deletePost, getAllPostsForHome, getUserPosts, updatePostContent, getUserPostById, } from "../controllers/post.controller.js";
...
router.route("/update-post-content/:postId").patch(verifyJWT, upload.fields([
    { name: "image", maxCount: 1 },
    { name: "video", maxCount: 1 },
]), updatePostContent);
